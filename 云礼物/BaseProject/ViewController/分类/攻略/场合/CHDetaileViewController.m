...
@interface CHDetaileViewController ()<UIWebViewDelegate>
...
@implementation CHDetaileViewController
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType{
    ...
    if (![request.URL.absoluteString isEqualToString:self.url.absoluteString]) {
        CHHTMLViewController *vc=[[CHHTMLViewController alloc] initWithRequest:request];
