...
@interface PLDetailViewController ()<UIWebViewDelegate>
...
- (BOOL)webView:(UIWebView *)webView shouldStartLoadWithRequest:(NSURLRequest *)request navigationType:(UIWebViewNavigationType)navigationType{
    ...
    if (![request.URL.absoluteString isEqualToString:self.path]) {
        PLHTMLViewController *vc=[[PLHTMLViewController alloc] initWithRequest:request];
